...
plt.savefig(PATH + 'training_dense.png')
plt.show()

# Result
predictions = model.predict(x_test)
visualize_result(test_labels, predictions, 'CONFUSION MATRIX', class_names)
plt.savefig(PATH + 'confusion_matrix_dense.png')
plt.show()

# Example
visualize_example(predictions, test_labels, test_images, class_names)
plt.savefig(PATH + "result_dense.png")
plt.show()

# save statistic
model.save_statistic('statistics_dense.csv')
'''